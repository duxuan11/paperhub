...
export function compileThemeConfig(
  ...
  const styles: Record<string, WechatThemeStyle> = {
    ...
    h1: {
      ...
      margin: "32px 0 16px",
      "padding-bottom": "12px",
      "border-bottom": `2px solid ${tint(primary, 0.7)}`,
    },
    h2: {
    ...
    h3: {
      ...
      margin: "22px 0 10px",
      "padding-bottom": "6px",
      "border-bottom": `1px dashed ${tint(primary, 0.55)}`,
    },
    h4: {
      "font-size": bodySize,
      "font-weight": "600",
    ...
    blockquote: {
      margin: "0 0 18px",
      padding: "14px 18px",
      "background-color": tint(primary, 0.95),
      border: `1px solid ${tint(primary, 0.85)}`,
      "border-left": `4px solid ${tint(primary, 0.6)}`,
      color: c.secondary,
      "font-size": bodySize,
      "line-height": "1.75",
      "border-radius": "8px",
    ...
    hr: {
      border: "none",
      "border-top": `2px solid ${tint(primary, 0.75)}`,
      width: "44px",
      margin: "30px auto",
    },
    link: {
    ...
    code: {
      "background-color": tint(primary, 0.9),
      color: primary,
      padding: "2px 6px",
      "border-radius": "4px",
      "font-size": "14px",
...
export const COMPONENT_GROUPS: {
...
}[] = [
  {
    ...
    hint: "文章大标题",
    fields: [
      { key: "h1", prop: "border-bottom", label: "下边框", type: "text" },
      { key: "h1", prop: "letter-spacing", label: "字距", type: "text" },
    ],
  },
  {
    label: "二级标题 H2",
    hint: "章节标题（默认色块卡片）",
    fields: [
      { key: "h2", prop: "background-color", label: "背景色", type: "color" },
      { key: "h2", prop: "border-left", label: "左侧竖线", type: "text" },
      { key: "h2", prop: "border-radius", label: "圆角", type: "text" },
    ],
  },
  {
    label: "三级标题 H3",
    hint: "小节标题",
    fields: [
      { key: "h3", prop: "color", label: "文字色", type: "color" },
      { key: "h3", prop: "border-bottom", label: "下边框", type: "text" },
    ],
  },
  {
    label: "引用块",
