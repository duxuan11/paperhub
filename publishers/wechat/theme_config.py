...
def compile_styles(config: dict[str, Any] | None = None) -> Styles:
    ...
    styles: Styles = {
        ...
        "h1": {
            ...
            "margin": "32px 0 16px",
            "padding-bottom": "12px",
            "border-bottom": f"2px solid {tint(primary, 0.7)}",
        },
        "h2": {
        ...
        "h3": {
            ...
            "margin": "22px 0 10px",
            "padding-bottom": "6px",
            "border-bottom": f"1px dashed {tint(primary, 0.55)}",
        },
        "h4": {
            "font-size": body_size,
            "font-weight": "600",
        ...
        "blockquote": {
            ...
            "border": f"1px solid {tint(primary, 0.85)}",
            "border-left": f"4px solid {tint(primary, 0.6)}",
            "color": c["secondary"],
            "font-size": body_size,
            "line-height": "1.75",
            "border-radius": "8px",
        ...
        "callout": {
            ...
            "border": f"1px solid {tint(primary, 0.78)}",
            "border-left": f"4px solid {primary}",
            "border-radius": "8px",
        },
        "calloutTitle": {
        ...
        "hr": {
            "border": "none",
            "border-top": f"2px solid {tint(primary, 0.75)}",
            "width": "44px",
            "margin": "30px auto",
        },
        "link": {
